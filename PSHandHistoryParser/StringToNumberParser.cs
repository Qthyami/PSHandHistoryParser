...
namespace PSHandHistoryParser
{
    internal class StringToNumberParser //кастомный вариант метода TryParse с возможностью менять типы, написана ChatGPT. Можно и без нее, просто прописывая if else и меняя типы чисел руками.
    {
